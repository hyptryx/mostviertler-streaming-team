...
class HeartScene {
    ...
    async play(stage, alert) {
        ...
        const heartMessages = MR.config.messages.heart;

        const randomMessage =
        heartMessages[Math.floor(Math.random() * heartMessages.length)];

        stage.innerHTML = `

        <div class="mr-heart-scene">

            <video
                class="mr-heart-video"
                autoplay
                playsinline>

                <source
                    src="assets/video/heart.webm"
                    type="video/webm">

            </video>

            <div class="mr-heart-text">
        ...
        const video = stage.querySelector(".mr-heart-video");
        const text = stage.querySelector(".mr-heart-text");
...
MR.scenes.heart = new HeartScene();